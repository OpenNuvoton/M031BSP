...
void ACMP01_IRQHandler(void)
{
    ...
    ACMP01->STATUS = (ACMP_STATUS_WKIF0_Msk<<1);
}
...
int32_t main(void)
{
    ...
    ACMP01->CTL[1] = (ACMP01->CTL[1] & ~(ACMP_CTL_NEGSEL_Msk | ACMP_CTL_HYSEN_Msk)) | (ACMP_CTL_NEGSEL_CRV | ACMP_CTL_HYSTERESIS_DISABLE | ACMP_CTL_ACMPEN_Msk);
