...
void SYS_Init(void)
{
    ...
    /* ADC clock source is PCLK1, set divider to 1, ADC clock is PCLK1 */
...
void ADC_FunctionTest()
{
    ...
    while(1)
    {
        ...
        if(u8Option == '1')
        {
            ...
            while((ADC->ADSR1 & (0x1<<0) ? 1 : 0) == 0);
            while((ADC->ADSR1 & (0x1<<1) ? 1 : 0) == 0);
            while((ADC->ADSR1 & (0x1<<2) ? 1 : 0) == 0);
            while((ADC->ADSR1 & (0x1<<3) ? 1 : 0) == 0);
