...
void SYS_Init(void)
{
    ...
    /* Enable UART0, ADC and Timer0 peripheral clock */
    CLK->APBCLK0 |= (CLK_APBCLK0_UART0CKEN_Msk | CLK_APBCLK0_ADCCKEN_Msk | CLK_APBCLK0_TMR0CKEN_Msk);
...
void TIMER0_Init()
{
    ...
    TIMER0->CTL = (TIMER0->CTL & ~(TIMER_CTL_TRGSSEL_Msk | TIMER_CTL_TRGPWM_Msk | TIMER_CTL_TRGADC_Msk | TIMER_CTL_TRGPDMA_Msk)) |
                  (TIMER_TRGSRC_TIMEOUT_EVENT | TIMER_TRG_TO_ADC);
}
    ...
    while(1)
    {
        ...
        if(u8Option == '1')
        {
            ...
            ADC->ADCR = (ADC->ADCR & ~(ADC_ADCR_DIFFEN_Msk | ADC_ADCR_ADMD_Msk | ADC_ADCR_TRGS_Msk | ADC_ADCR_TRGCOND_Msk | ADC_ADCR_TRGEN_Msk)) |
                        (ADC_ADCR_DIFFEN_SINGLE_END | ADC_ADCR_ADMD_SINGLE | ADC_ADCR_TRGS_TIMER | ADC_ADCR_TRGEN_Msk | ADC_ADCR_ADIE_Msk);
        ...
        else if(u8Option == '2')
        {
            ...
            /* Configure the sample module and enable TIMER trigger source */
            ADC->ADCR = (ADC->ADCR & ~(ADC_ADCR_DIFFEN_Msk | ADC_ADCR_ADMD_Msk | ADC_ADCR_TRGS_Msk | ADC_ADCR_TRGCOND_Msk | ADC_ADCR_TRGEN_Msk)) |
                        (ADC_ADCR_DIFFEN_DIFFERENTIAL | ADC_ADCR_ADMD_SINGLE | ADC_ADCR_TRGS_TIMER | ADC_ADCR_TRGEN_Msk | ADC_ADCR_ADIE_Msk);
            ADC->ADCHER = (ADC->ADCHER & ~ADC_ADCHER_CHEN_Msk) | (BIT2);
...
int32_t main(void)
{
    ...
    /* Disable ADC and Timer0 IP clock */
    CLK->APBCLK0 &= ~(CLK_APBCLK0_TMR0CKEN_Msk | CLK_APBCLK0_ADCCKEN_Msk);
