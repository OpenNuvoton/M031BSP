...
void USCI_UART_DataWakeUp(void)
{
    ...
    UUART0->BRGEN = (999 << UUART_BRGEN_CLKDIV_Pos) | (9 << UUART_BRGEN_DSCNT_Pos);
...
void USCI_UART_PowerDownWakeUpTest(void)
{
    ...
    if (u32Item == '2')
    {
        UUART0->BRGEN = (999 << UUART_BRGEN_CLKDIV_Pos) | (9 << UUART_BRGEN_DSCNT_Pos); /* Set UART baud rate as 1200bps */
