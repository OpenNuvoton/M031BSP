...
void SYS_Init(void)
{
    ...
    /* ADC clock source is HXT, set divider to 255, ADC clock is HXT/255 MHz */
    CLK->CLKSEL2 = (CLK->CLKSEL2 & ~CLK_CLKSEL2_ADCSEL_Msk) | CLK_CLKSEL2_ADCSEL_HXT;
    CLK->CLKDIV0 = (CLK->CLKDIV0 & ~CLK_CLKDIV0_ADCDIV_Msk) | CLK_CLKDIV0_ADC(255);
...
void ADC_FunctionTest()
{
    ...
    ADC->ESMPCTL |= (0xF << ADC_ESMPCTL_EXTSMPT_Pos);
