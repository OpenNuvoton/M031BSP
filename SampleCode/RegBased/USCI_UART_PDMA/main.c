...
#define UUART_TX_DMA_CH 0
#define UUART_RX_DMA_CH 1
...
void PDMA_Init(void)
{
    ...
    PDMA->DSCT[UUART_TX_DMA_CH].SA = (uint32_t)(&g_u8Tx_Buffer[0]);     /* Source address */
    ...
    PDMA->DSCT[UUART_RX_DMA_CH].DA = (uint32_t)(&g_u8Rx_Buffer[0]);    /* Destination address */
    ...
    PDMA->INTEN |= ((1 << UUART_RX_DMA_CH) | (1 << UUART_TX_DMA_CH));
