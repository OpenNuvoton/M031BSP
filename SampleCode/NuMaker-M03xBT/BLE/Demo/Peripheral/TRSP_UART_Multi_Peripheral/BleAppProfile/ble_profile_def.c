...
ATTRIBUTE_BLE_Hdl_Para ATT_Hdl_Para_LinkP01[SIZE_ARRAY_ROW(ATT_SERVICE_COMB00)]; // Link 1
ATTRIBUTE_BLE_Hdl_Para ATT_Hdl_Para_LinkP02[SIZE_ARRAY_ROW(ATT_SERVICE_COMB00)]; // Link 2
...
const ATTR_DB_Mapping_by_ID ATT_DB_MAPPING[] =
{
    ...
    {
        ((ATTRIBUTE_BLE_Hdl_Para *)0),    // Client Link Parameter
        ATT_Hdl_Para_LinkP02,             // Server Link Parameter
    },
};
