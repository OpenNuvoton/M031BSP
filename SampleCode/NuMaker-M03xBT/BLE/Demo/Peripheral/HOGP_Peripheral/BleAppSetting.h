...
#define BLE_SUPPORT_BOND            ENABLE_DEF
...
/* BLE IO Capability */
#define IOCAPABILITY_SETTING        KEYBOARD_ONLY       //selected IO Capability : KEYBOARD_ONLY/DISPLAY_ONLY

/* HOGP Pairing Key Setting */
#if (IOCAPABILITY_SETTING == DISPLAY_ONLY)
#define BLE_PAIRING_KEY             654321              //pairing key (uint32_t)
#endif
