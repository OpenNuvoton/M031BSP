#ifndef _BLE_SERVICE_HID_KB_MS_CS_H_
#define _BLE_SERVICE_HID_KB_MS_CS_H_

/**************************************************************************//**
 * @file  ble_service_hid_kb_ms_cs.h
 * @brief Provide the Definition of HID_KB_MS_CS Service.
*****************************************************************************/
 ...
 * HID Definitions
 **************************************************************************/
/** @defgroup serviceHidKbMsCs_def BLE HID Service Definitions
 * @{
 * @ingroup service_def
...
/**
 * @ingroup serviceHidKbMsCs_def
 * @defgroup serviceHidKbMsCs_UUIDDef BLE HID Service UUID Definitions
 * @{
...
/**
 * @defgroup serviceHidKbMsCs_ServiceChardef BLE HID Service and Characteristic Definitions
 * @{
 * @ingroup serviceHidKbMsCs_def
...
/**
 * @ingroup serviceHidKbMsCs_ServiceChardef
 * @{
*/
 ...
 **************************************************************************/
/** @defgroup appHidKbMsCs_def BLE HID Service Application Definitions
 * @{
 * @ingroup serviceHidKbMsCs_def
...
#define BLESERVICE_HID_BOOT_MOUSE_INPUT_REPORT_READ_EVENT               0x12   /**< HID boot mouse input report read event. */
#define BLESERVICE_HID_BOOT_MOUSE_INPUT_REPORT_WRITE_EVENT              0x13   /**< HID boot mouse input report write event. */
#define BLESERVICE_HID_BOOT_MOUSE_INPUT_REPORT_NOTIFY_EVENT             0x14   /**< HID boot mouse input report notify event. */
#define BLESERVICE_HID_BOOT_MOUSE_INPUT_REPORT_CCCD_WRITE_EVENT         0x15   /**< HID boot mouse input report cccd write event. */
#define BLESERVICE_HID_BOOT_MOUSE_INPUT_REPORT_CCCD_READ_EVENT          0x16   /**< HID boot mouse input report cccd read event. */
#define BLESERVICE_HID_MOUSE_INPUT_REPORT_READ_EVENT                    0x17   /**< HID mouse input report read event. */
#define BLESERVICE_HID_MOUSE_INPUT_REPORT_WRITE_EVENT                   0x18   /**< HID mouse input report write event. */
#define BLESERVICE_HID_MOUSE_INPUT_REPORT_NOTIFY_EVENT                  0x19   /**< HID mouse input report notify event. */
#define BLESERVICE_HID_MOUSE_INPUT_REPORT_CCCD_WRITE_EVENT              0x1A   /**< HID mouse input report cccd write event. */
#define BLESERVICE_HID_MOUSE_INPUT_REPORT_CCCD_READ_EVENT               0x1B   /**< HID mouse input report cccd read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_READ_EVENT                 0x1C   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_WRITE_EVENT                0x1D   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_NOTIFY_EVENT               0x1E   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_CCCD_WRITE_EVENT           0x1F   /**< HID consumer input report cccd write event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_CCCD_READ_EVENT            0x20   /**< HID consumer input report cccd write event. */
/** @} */


/**
 * @ingroup appHidKbMsCs_def
 * @defgroup appHidKbMsCs_structureDef BLE HID Structure Definitions
 * @{
 ...
 * @ingroup appHidKbMsCs_structureDef
*/
 ...
 * @ingroup appHidKbMs_structureDef
*/
...
/**
 * @ingroup appHidKbMsCs_def
 * @defgroup appHidKbMsCs_App BLE HID Definitions for Application
 * @{
...
#endif  //_BLE_SERVICE_HID_KB_MS_CS_H_
