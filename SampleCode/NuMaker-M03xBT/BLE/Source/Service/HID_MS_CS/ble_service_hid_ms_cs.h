#ifndef _BLE_SERVICE_HID_MS_CS_H_
#define _BLE_SERVICE_HID_MS_CS_H_

/**************************************************************************//**
 * @file  ble_service_hid_ms_cs.h
 * @brief Provide the Definition of HID_MS_CS Service.
*****************************************************************************/
 ...
 * HID Definitions
 **************************************************************************/
/** @defgroup serviceHidMsCs_def BLE HID Service Definitions
 * @{
 * @ingroup service_def
...
/**
 * @ingroup serviceHidMsCs_def
 * @defgroup serviceHidMsCs_UUIDDef BLE HID Service UUID Definitions
 * @{
...
/**
 * @defgroup serviceHidMsCs_ServiceChardef BLE HID Service and Characteristic Definitions
 * @{
 * @ingroup serviceHidMsCs_def
...
/**
 * @ingroup serviceHidMsCs_ServiceChardef
 * @{
*/
 ...
 **************************************************************************/
/** @defgroup appHidMsCs_def BLE HID Service Application Definitions
 * @{
 * @ingroup serviceHidMsCs_def
...
**************************************************************************/
/**
 * @ingroup appHidMsCs_def
 * @defgroup appHidMsCs_eventDef BLE HID Service and Characteristic Definitions
 * @{
...
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_READ_EVENT                 0x0E   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_WRITE_EVENT                0x0F   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_NOTIFY_EVENT               0x10   /**< HID consumer input report read event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_CCCD_WRITE_EVENT           0x11   /**< HID consumer input report cccd write event. */
#define BLESERVICE_HID_CONSUMER_INPUT_REPORT_CCCD_READ_EVENT            0x12   /**< HID consumer input report cccd write event. */
/** @} */


/**
 * @ingroup appHidMsCs_def
 * @defgroup appHidMsCs_structureDef BLE HID Structure Definitions
 * @{
 ...
 * @ingroup appHidMsCs_structureDef
*/
...
/**
 * @ingroup appHidMsCs_def
 * @defgroup appHidMsCs_App BLE HID Definitions for Application
 * @{
...
#endif //_BLE_SERVICE_HID_MS_CS_H_
