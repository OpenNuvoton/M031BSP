/************************************************************************
 *
 * File Name  : BLE_SERVICE_HID_MS_CS.c
 * Description: This file contains the definitions and functions of BLE HID_MS_CS
 *
 *
 ************************************************************************/
#include "ble_service_hid_ms_cs.h"
...
static void handle_HID_server(uint8_t index, BLE_Event_AttParam *attParam)
{
    ...
    case OPCODE_ATT_READ_REQUEST:
        //============== handle cccd ===================================================================
        if (attParam->hdlNum == hidInfo[index]->handles.hdl_hid_boot_mouse_input_report_cccd)
        {
