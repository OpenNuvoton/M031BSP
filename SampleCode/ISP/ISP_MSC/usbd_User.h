...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M031 Series supports 8 hardware endpoint ID. This parameter could be 0 ~ 7.
  *
  * @return     None
  *
...
/**
  ...
  *
  * @param[in]  ep The USB endpoint ID. M031 Series supports 8 endpoint ID. This parameter could be 0 ~ 7.
  *
...
/*@}*/ /* end of group M031_USBD_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group M031_USBD_Driver */

/*@}*/ /* end of group M031_Device_Driver */
